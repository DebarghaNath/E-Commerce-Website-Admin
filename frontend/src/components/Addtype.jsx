...
useEffect(()=>{
  const fetch= async ()=>{
      ...
      const table = await axios.get("http://localhost:3000/brandtype",{
        headers:{
            'Content-Type': 'application/json'
        },
        withCredentials: true
...
const currentBrands = dis.slice(offset, offset + typeperpage);
const pageCount = Math.ceil(dis.length / typeperpage);
      ...
      <div className="main-panel">
        ...
        <div className="container">
          <div className="page-inner">
            ...
            >
              <div>
                <h3 className="fw-bold mb-3">ADD NEW TYPE HERE</h3>
            ...
            <div class="table-responsive">
              ...
              <tbody>
                    {currentBrands.map((dis) => (
                        <tr key={dis.category_id}>
                            <td>{dis.category_id}</td>
                            <td>{dis.category_name}</td>
                        </tr>
                    ))}
                </tbody>
            </table>
